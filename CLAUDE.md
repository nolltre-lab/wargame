...
- [ ] **Missile non-direct routing** — cruise missiles can fly terrain-following or waypoint-planned paths instead of straight lines (allows routing around mountains, coastal masking); requires waypoint list on Missile entity
